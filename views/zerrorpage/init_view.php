                            ...
                            <div class="card">
                                <div class="card-body p-0 auth-header-box">
                                    <div class="text-center p-3">
                                        ...
                                        <p class="text-muted  mb-0">Back to dashboard of Nagbak.</p>  
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="ex-page-content text-center">
                                        <img src="./theme/assets/images/error.svg" alt="0" class="" height="170">
                                        <h1 class="mt-5 mb-4">404!</h1>  
                                        <h5 class="font-16 text-muted mb-5">Somthing went wrong</h5>                                    
                                    </div>          
                                    <a class="btn btn-primary btn-block waves-effect waves-light" href="<?php echo URL;?>?page=dashboard&action=init">Back to Dashboard <i class="fas fa-redo ml-1"></i></a>                         
                                </div>
