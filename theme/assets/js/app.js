...
(function ($) {
    ...
    function customactivemenu(){
        ...
        $('#'+page).parent().addClass("active"); // add active to li of the current link                 
        $('#'+page).parent().parent().addClass("in");
        $('#'+page).parent().parent().addClass("mm-show");
        $('#'+page).parent().parent().parent().addClass("mm-active");
    }
